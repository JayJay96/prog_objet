...
public class AgentsDodge extends AgentsInteraction {
	...
	/*		if(hostingAgent.getPhysicalInfo().getCoordinates().getX()>space.getX() ){	
			...
			if (vector.size < this.dodgeDistance) {
				//if(hostingAgent.getRoles().get(0).getName().equals(closerAgent.getRoles().get(0).getName())){
